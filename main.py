...
def lizzard_spawn(rand, enemies):
    ...
    if num < rand:
        ...
        lizzard['lizzard'] = pygame.transform.scale(lizzard['lizzard'], (96, 96))
...
if __name__ == '__main__':
    ...
    story1 = pygame.transform.scale(story1, (SCREEN_X, SCREEN_Y))
    story2 = pygame.image.load("./backStory2.png")
    story2 = pygame.transform.scale(story2, (SCREEN_X, SCREEN_Y))
    story3 = pygame.image.load("./backStory3.png")
    story3 = pygame.transform.scale(story3, (SCREEN_X, SCREEN_Y))
    story4 = pygame.image.load("./backStory4.png")
    story4 = pygame.transform.scale(story4, (SCREEN_X, SCREEN_Y))
    ...
    while running:
        ...
        if(firstRun):
            ...
            print("NEXT")
            screen.blit(story2, (cutsceneX, cutsceneY))
            pygame.display.update()
            ...
            screen.blit(story3, (cutsceneX, cutsceneY))
            pygame.display.update()
            ...
            screen.blit(story4, (cutsceneX, cutsceneY))
            pygame.display.update()
        ...
        enemies = lizzard_spawn(10*level*.5, enemies)
        inds = []
        for ind, enemie in enumerate(enemies):
            speedX = random.randint(1, 50)*level*.25
            speedY = random.randint(1, 50)*level*.25
        ...
        score_text = font.render(f"Score: {str((score)*10)}", True, (255, 255, 255))
        screen.blit(score_text, (SCREEN_X - score_text.get_width() - 20, 20))
    ...
    if win:
        ...
        screen.blit(win, (int(SCREEN_X/2 - win.get_width()/2), int(SCREEN_Y/2)))
        score_text = font.render(f"Score: {str((score)*10)}", True, (255, 255, 255))
        screen.blit(score_text, (SCREEN_X - score_text.get_width() - 20, 20))
        pygame.display.update()
    ...
    if ded:
        screen.fill((0, 0, 0))
        win = font.render("YOU DIED ", True, (255, 0, 0))
        screen.blit(win, (int(SCREEN_X/2 - win.get_width()/2), int(SCREEN_Y/2)))
        score_text = font.render(f"Score: {str((score)*10)}", True, (255, 255, 255))
        screen.blit(score_text, (SCREEN_X - score_text.get_width() - 20, 20))
        pygame.display.update()
